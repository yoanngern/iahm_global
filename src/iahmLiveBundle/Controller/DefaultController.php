...
David a voyagé dans tous les Etats-Unis et autour du monde équipant les chrétiens par des conférences prophétiques, des rencontres pour les jeunes et les enfants et des conférences de formation de leaders. Au travers de son ministère, il a vu des milliers de personne expérimenter la vraie libération de la captivité et de la maladie.',
		...
		$event5 = array(
			...
			'live'         => array(
				...
				'youtube_id'      => 'oZ4wXyrmvlg',
				'facebook_link' => 'https://www.facebook.com/iahm.international/videos/1121630187927907/'
			),
			...
			'speaker' => array(
				...
				'presentation' => array(
					'en' => array(
						'bio' => 'Both Chris and Liz were born and raised in New Zealand. Chris was a Pastor in Auckland for 6 years from the year 2000. Chris and Liz also have 3 amazing daughters, Charlotte, Emma and Sophie.
						Chris has ministered internationally in Australia, Canada, USA, Mexico, Mozambique, New Zealand, India, Singapore, and Ecuador and ministers across denominational lines. They have believed in healing for many years but up to 2005, had failed to see anybody healed even after praying for close to 1000 people. In 2005, Chris had an incredible encounter with God and he saw his first person instantly healed. In 2006, Chris went on a missions trip to India with Randy Clark and saw many thousands of people healed by the power of Jesus, including many blind eyes opening, deaf ears being opened, the lame walking and cancer tumors dissolving in his hands.',
					),
					'fr' => array(
						'bio' => 'Chris et Liz Gore ont une passion pour voir les malades guéris, ainsi que pour les chrétiens marchant dans la puissance et l\'amour de Jésus. Ils désirent voir le réveil se propager et l\'Evangile du Royaume prêché dans toutes les nations. Chris est devenu pasteur et superviseur des ministères de guérison à l\'Eglise Bethel à Redding en Californie. Ils continuent à voir le don de guérison se manifester au-travers de leur ministère !',
					),
				),
				'image'        => 'GoreChris.png',
				'website'      => array(
					'url'   => 'http://www.kingdomreleasers.org',
					'label' => 'kingdomreleasers.org'
				),
			),
		);
